...
minmax_scaler=pickle.load(open("model/scaler.pkl","rb"))
...
def predict_rul1():
    if request.method=="POST":
        ...
        new_data_scaled1=minmax_scaler.transform([[sensor2, sensor3, sensor4, sensor7, sensor8, sensor9, sensor11, sensor12, sensor13, sensor14, sensor15, sensor17, sensor20, sensor21]])
...
def predict_rul2():
    if request.method=="POST":
        ...
        new_data_scaled2=minmax_scaler.transform([[sensor1, sensor2, sensor3, sensor4, sensor5, sensor6, sensor7, sensor8, sensor9, sensor10, sensor11, sensor12, sensor14, sensor15, sensor17, sensor18, sensor20, sensor21]])
...
def predict_rul3():
    if request.method=="POST":      
        ...
        new_data_scaled3=minmax_scaler.transform([[sensor2, sensor3, sensor4, sensor7, sensor8, sensor9, sensor11, sensor12, sensor13, sensor14, sensor15, sensor17, sensor20, sensor21]])
...
def predict_rul4():
    if request.method=="POST":
        ...
        new_data_scaled4=minmax_scaler.transform([[sensor1, sensor2, sensor3, sensor4, sensor5, sensor6, sensor7, sensor8, sensor9, sensor10, sensor11, sensor12, sensor14, sensor15, sensor17, sensor18, sensor20, sensor21]])
