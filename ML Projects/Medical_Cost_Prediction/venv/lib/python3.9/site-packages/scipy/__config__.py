...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.14.0",
                "include directory": r"../../pip-build-env-6014nofx/overlay/lib/python3.9/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"/private/var/folders/76/zy5ktkns50v6gt5g8r0sf6sc0000gn/T/cibw-run-dp6he_rc/cp39-macosx_arm64/build/venv/bin/python",
            "version": "3.9",
        },
    }
)
